  ...
  <div class="modal-dialog" role="document">
    <div class="modal-content">
      ...
      <div class="modal-body border-bottom px-0">
        <form action="{{route('addproducts')}}" method="post" enctype="multipart/form-data" id="addProductForm">
          @csrf
          <div class="inputfields px-4">
            ...
            <div class="form-group">
              ...
              <textarea id="product-desc" name="desc" rows="10" class="form-control @error('desc') is-invalid @enderror" required>{{old('desc')}}</textarea>
